...
class WebBasePinyin{
	function ToPinYin($_String, $_Code='utf-8')
	{
	...
	function ToPinYinCap($str){
		$str=$this->_U2_Utf8_Gb($str);//iconv("UTF-8","gb2312", $str);
		echo $str;
		$rtn="";
		for($i=0; $i<strlen($str); $i++)
		{
			$s=substr($str, $i, 1);
			echo $s."<br/>";
			$rtn.=$this->ToCaption($s);
		}
		return $rtn;
	}
	function _webbase_pinyin($_Num, $_Data)
	{
